    ...
    <div class="card">
        <div class="card-body">
            <div class="basic-form">
                <form id="userForm" class="form-horizontal form-label-left" novalidate  action="<?= base_url('Playground/aksi_edit_list_permainan')?>" method="post">
                 ...
                 <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <div class="input-group mb-3 input-basic">
                            ...
                            <input type="text" id="harga_permainan" name="harga_permainan" class="form-control text-capitalize" placeholder="Harga Permainan /Jam" oninput="validateNumberInput(this)" autocomplete="on" value="<?= $data->harga_permainan?>">
          ...
          <a href="<?= base_url('/Playground/list_permainan/')?>" type="submit" class="btn btn-primary">Kembali</a></button>
