<div class="row">
    <div class="col-md-5 col-sm-5 col-xs-5">
        <div class="card">
            <div class="card-bg" style="background-image: url('/acc/acc.jpeg');">
                <div class="card-body">
                    <div style="text-align: center;">
                        <img src="<?= base_url('/assets/images/profile/default-profile-photo.jpeg')?>" width="80" style="border-radius: 50%;" alt=""/>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th>Level :</th>
                            <td class="text-capitalize"><?= getRole($use->level) ?></td>
                        </tr>
                        <?php
                        ...
                        <tr>
                            <th>No Telepon :</th>
                            <td class="text-capitalize"><?= $pegawai->no_telp ?></td>
                        </tr>
                    </table>
                </div>
            </div>
