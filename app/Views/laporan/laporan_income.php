        ...
        <tbody>
          ...
          foreach ($data as $dataa) {
            ...
            <tr>
              ...
              <td class="text-capitalize text-center"><?php echo $dataa->nama_pemain?></td>
              <td class="text-center text-capitalize text-dark text-success">Rp <?php echo $dataa->total_harga?>,00</td>
            </tr>

            <?php
            $totalIncome += $dataa->total_harga; 
          }
          ?>
          ...
          <tr>
            <td colspan="2"></td>
            <td><b>TOTAL :</b></td>
            <td style="color: seagreen;"><b>Rp <?php echo $totalIncome?>.000,00</b></td>
          </tr>
